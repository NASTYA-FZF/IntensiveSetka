...
// IntensiveSetka.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CIntensiveSetkaApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CIntensiveSetkaApp

CIntensiveSetkaApp::CIntensiveSetkaApp()
{
...
// Единственный объект CIntensiveSetkaApp

CIntensiveSetkaApp theApp;


// Инициализация CIntensiveSetkaApp

BOOL CIntensiveSetkaApp::InitInstance()
{
